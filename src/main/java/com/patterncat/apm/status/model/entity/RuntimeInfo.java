...
public class RuntimeInfo extends BaseEntity<RuntimeInfo> {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof RuntimeInfo) {
            ...
            if (m_startTime != _o.getStartTime()) {
                return false;
            }

            if (m_upTime != _o.getUpTime()) {
                return false;
            }

            if (!equals(m_javaVersion, _o.getJavaVersion())) {
                return false;
            }
            ...
            if (!equals(m_userDir, _o.getUserDir())) {
                return false;
            }

            if (!equals(m_javaClasspath, _o.getJavaClasspath())) {
                return false;
            }
