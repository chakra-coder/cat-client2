...
import com.patterncat.apm.config.KVConfig;
import com.patterncat.apm.message.spi.MessageQueue;
import com.patterncat.apm.service.MessageIdFactory;
import com.patterncat.apm.service.TcpSocketSender;
import com.patterncat.apm.utils.*;
...
public class ChannelManager implements Threads.Task {
    ...
    private Logger m_logger = LoggerFactory.getLogger(ChannelManager.class);
