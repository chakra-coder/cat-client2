...
import com.patterncat.apm.message.io.ChannelManager;
import com.patterncat.apm.message.io.DefaultMessageQueue;
import com.patterncat.apm.message.io.MessageSender;
import com.patterncat.apm.message.spi.MessageCodec;
import com.patterncat.apm.message.spi.MessageQueue;
...
public class TcpSocketSender implements Threads.Task, MessageSender {
    ...
    private Logger m_logger = LoggerFactory.getLogger(TcpSocketSender.class);
