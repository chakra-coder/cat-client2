...
import com.patterncat.apm.message.TaggedTransaction;
import com.patterncat.apm.message.Transaction;
import com.patterncat.apm.message.internal.DefaultEvent;
import com.patterncat.apm.message.internal.DefaultForkedTransaction;
import com.patterncat.apm.message.internal.DefaultTaggedTransaction;
...
import com.patterncat.apm.message.spi.internal.DefaultMessageTree;
...
public class DefaultMessageManager implements MessageManager {
    ...
    private Logger m_logger = LoggerFactory.getLogger(DefaultMessageManager.class);
