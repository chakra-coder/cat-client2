...
import com.patterncat.apm.message.spi.codec.BufferWriter;
import com.patterncat.apm.message.spi.codec.EscapingBufferWriter;
...
public class PlainTextMessageCodec implements MessageCodec {
    ...
    private Logger m_logger = LoggerFactory.getLogger(PlainTextMessageCodec.class);
