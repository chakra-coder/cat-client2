...
public class Server extends BaseEntity<Server> {
    ...
    public void mergeAttributes(Server other) {
        assertAttributeEquals(other, com.patterncat.apm.config.client.Constants.ENTITY_SERVER, com.patterncat.apm.config.client.Constants.ATTR_IP, m_ip, other.getIp());
